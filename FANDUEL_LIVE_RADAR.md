...
> **Last Updated:** `2026-09-20 07:11:41 UTC`
...
| **Wuhan Open (WTA 1000 Live)** | **Iga Swiatek** vs **Aryna Sabalenka**<br>🟢 `Set 2 (6-3, 2-4) • Swiatek Serving 40-30` | Iga Swiatek `1.82` (-122)<br>Aryna Sabalenka `2.05` (+105) | `1.35 / 3.88` | **Iga Swiatek:** 74.2%<br>**Aryna Sabalenka:** 25.8% | **+21.28%** | `10.71u` on Iga Swiatek FanDuel ML @ 1.82 (-122) |
...
| **Japan Open Tokyo (FanDuel Board)** | **Ben Shelton** vs **Carlos Alcaraz**<br>🕒 Upcoming • Tonight 23:00 ET | Ben Shelton: `3.80` → `3.75`<br>Carlos Alcaraz: `1.28` → `1.30` | `4.76 / 1.27` | **+4.75%** | `Carlos Alcaraz FanDuel ML @ 1.30 (-333)` | `2.26u` |
| **Korea Open Seoul (FanDuel Board)** | **Coco Gauff** vs **Elena Rybakina**<br>🕒 Upcoming • Tomorrow 03:30 ET | Coco Gauff: `1.88` → `1.90`<br>Elena Rybakina: `1.98` → `1.96` | `2.34 / 1.75` | **+7.99%** | `Elena Rybakina FanDuel ML @ 1.96 (-104)` | `3.16u` |
| **Shanghai Masters (ATP 1000 FanDuel Board)** | **Novak Djokovic** vs **Challenger Qualifier**<br>🕒 Upcoming • Tomorrow 06:00 ET | Novak Djokovic: `1.09` → `1.08`<br>Challenger Qualifier: `8.20` → `8.50` | `1.01 / 98.81` | **+10.26%** | `Novak Djokovic FanDuel ML @ 1.08 (-1250)` | `21.59u` |
