...
> **Last Updated:** `2026-09-23 00:02:02 UTC`
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **China Open Beijing (FanDuel Featured)** | **Daniil Medvedev** vs **Alexander Zverev**<br>🕒 Upcoming • Today 19:00 ET | Daniil Medvedev: `2.10` → `2.15`<br>Alexander Zverev: `1.78` → `1.75` | `2.34 / 1.75` | **+2.06%** | `Alexander Zverev FanDuel ML @ 1.75 (-133)` | `0.03u` |
...
| **Korea Open Seoul (FanDuel Board)** | **Coco Gauff** vs **Elena Rybakina**<br>🕒 Upcoming • Tomorrow 03:30 ET | Coco Gauff: `1.88` → `1.90`<br>Elena Rybakina: `1.98` → `1.96` | `2.35 / 1.74` | **+8.24%** | `Elena Rybakina FanDuel ML @ 1.96 (-104)` | `3.29u` |
| **Shanghai Masters (ATP 1000 FanDuel Board)** | **Novak Djokovic** vs **Challenger Qualifier**<br>🕒 Upcoming • Tomorrow 06:00 ET | Novak Djokovic: `1.09` → `1.08`<br>Challenger Qualifier: `8.20` → `8.50` | `1.01 / 93.63` | **+10.20%** | `Novak Djokovic FanDuel ML @ 1.08 (-1250)` | `21.39u` |
