...
> **Last Updated:** `2026-09-19 17:27:55 UTC`
...
| **Wuhan Open (WTA 1000 Live)** | **Iga Swiatek** vs **Aryna Sabalenka**<br>🟢 `Set 2 (6-3, 2-4) • Swiatek Serving 40-30` | Iga Swiatek `1.82` (-122)<br>Aryna Sabalenka `2.05` (+105) | `1.35 / 3.86` | **Iga Swiatek:** 74.1%<br>**Aryna Sabalenka:** 25.9% | **+21.14%** | `10.63u` on Iga Swiatek FanDuel ML @ 1.82 (-122) |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **China Open Beijing (FanDuel Featured)** | **Daniil Medvedev** vs **Alexander Zverev**<br>🕒 Upcoming • Today 19:00 ET | Daniil Medvedev: `2.10` → `2.15`<br>Alexander Zverev: `1.78` → `1.75` | `2.35 / 1.74` | **+2.25%** | `Alexander Zverev FanDuel ML @ 1.75 (-133)` | `0.14u` |
...
| **Korea Open Seoul (FanDuel Board)** | **Coco Gauff** vs **Elena Rybakina**<br>🕒 Upcoming • Tomorrow 03:30 ET | Coco Gauff: `1.88` → `1.90`<br>Elena Rybakina: `1.98` → `1.96` | `2.37 / 1.73` | **+8.49%** | `Elena Rybakina FanDuel ML @ 1.96 (-104)` | `3.41u` |
| **Shanghai Masters (ATP 1000 FanDuel Board)** | **Novak Djokovic** vs **Challenger Qualifier**<br>🕒 Upcoming • Tomorrow 06:00 ET | Novak Djokovic: `1.09` → `1.08`<br>Challenger Qualifier: `8.20` → `8.50` | `1.01 / 94.52` | **+10.21%** | `Novak Djokovic FanDuel ML @ 1.08 (-1250)` | `21.42u` |
