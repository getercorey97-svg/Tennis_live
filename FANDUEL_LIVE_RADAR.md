...
| **Wuhan Open (WTA 1000 Live)** | **Iga Swiatek** vs **Aryna Sabalenka**<br>🟢 `Set 2 (6-3, 2-4) • Swiatek Serving 40-30` | Iga Swiatek `1.82` (-122)<br>Aryna Sabalenka `2.05` (+105) | `1.36 / 3.78` | **Iga Swiatek:** 73.6%<br>**Aryna Sabalenka:** 26.5% | **+20.58%** | `10.32u` on Iga Swiatek FanDuel ML @ 1.82 (-122) |
...
| **Korea Open Seoul (FanDuel Board)** | **Coco Gauff** vs **Elena Rybakina**<br>🕒 Upcoming • Tomorrow 03:30 ET | Coco Gauff: `1.88` → `1.90`<br>Elena Rybakina: `1.98` → `1.96` | `2.37 / 1.73` | **+8.58%** | `Elena Rybakina FanDuel ML @ 1.96 (-104)` | `3.46u` |
